...
The `reprex` data set we have created allows to inspect the logic of our script manually and have a much higher confidence that it does what we expect it to do. Now we can apply this solution to the real data. Notice also, that we create a variation of this solution, apply to the new criterion of the "day zero" - the day of the first confirmed mortality in the country. 
...
With all variable prepared for plotting, let us develop the barebones graph first, to help us see the structure and the components: 
